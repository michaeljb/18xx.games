...
SKIP_BETA_PROD = {
  ...
  '18NY 1st Edition' => %i[bankrupt custom],
  '18NY' => %i[bankrupt custom],
  '18Neb' => [:bankrupt],
  ...
  '18ZOO - Map D' => %i[stock_market custom],
  '18ZOO - Map E' => %i[stock_market custom],
  '18ZOO - Map F' => %i[stock_market custom],
  '18ZOO' => %i[stock_market custom],
}.freeze
